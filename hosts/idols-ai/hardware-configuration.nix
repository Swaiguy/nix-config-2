...
#
{
  ...
  boot.initrd = {
    ...
    luks.devices."crypted-nixos" = {
      ...
      device = "/dev/disk/by-uuid/624a048e-a15d-4b04-b737-caccc27c25f2";
  ...
  fileSystems."/btr_pool" = {
    device = "/dev/disk/by-uuid/fcd47e63-a6f4-4736-aa00-6151af2f4d88";
    fsType = "btrfs";
  ...
  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/41E0-AA82";
    fsType = "vfat";
  };
